...
mod section_3_10_1_non_initial_characters {
    ...
    fn test_invalid_initial_digits() {
        ...
        assert!(
            result.is_err(),
            "Should reject identifier starting with digit '1abc'"
        );
        ...
        assert!(
            result.is_err(),
            "Should reject identifier starting with digit '9xyz'"
        );
    }
    ...
    fn test_invalid_plus_followed_by_digit() {
        ...
        use crate::validation::validate_identifier_string_with_context;

        let result =
            validate_identifier_string_with_context("+1", proc_macro2::Span::call_site(), true);
        assert!(
            result.is_err(),
            "Should reject identifier '+1' (+ followed by digit)"
        );
        ...
        assert!(
            result.is_err(),
            "Should reject identifier '+123abc' (+ followed by digit)"
        );
    }
    ...
    fn test_invalid_minus_followed_by_digit() {
        ...
        let result =
            validate_identifier_string_with_context("-42abc", proc_macro2::Span::call_site(), true);
        assert!(
            result.is_err(),
            "Should reject identifier '-42abc' (- followed by digit)"
        );
    }
    ...
    fn test_invalid_dot_followed_by_digit() {
        ...
        let result =
            validate_identifier_string_with_context(".123", proc_macro2::Span::call_site(), true);
        assert!(
            result.is_err(),
            "Should reject identifier '.123' (. followed by digit)"
        );
    }
    ...
    fn test_valid_sign_dot_non_digit_pattern() {
        ...
        assert!(
            result.is_ok(),
            "Should accept identifier '+.foo' (+. followed by non-digit)"
        );
        ...
        assert!(
            result.is_ok(),
            "Should accept identifier '-.bar' (-. followed by non-digit)"
        );
    }
}
...
mod section_3_10_2_non_identifier_characters {
    ...
    fn test_invalid_punctuation_characters() {
        ...
        for ch in invalid_chars {
            ...
            assert!(
                result.is_err(),
                "Should reject identifier '{}' containing '{}'",
                identifier,
                ch
            );
        }
    ...
    fn test_invalid_whitespace_characters() {
        ...
        for ch in whitespace_chars {
            ...
            assert!(
                result.is_err(),
                "Should reject identifier containing whitespace U+{:04X}",
                ch as u32
            );
        }
    }
    ...
    fn test_invalid_newline_characters() {
        ...
        for ch in newline_chars {
            ...
            assert!(
                result.is_err(),
                "Should reject identifier containing newline U+{:04X}",
                ch as u32
            );
        }
    }
    ...
    fn test_invalid_disallowed_code_points() {
        ...
        for ch in disallowed_chars {
            ...
            assert!(
                result.is_err(),
                "Should reject identifier containing disallowed code point U+{:04X}",
                ch as u32
            );
        }
    }
...
mod disallowed_patterns {
    ...
    fn test_number_like_patterns() {
        ...
        for identifier in number_like_identifiers {
            ...
            assert!(
                result.is_err(),
                "Should reject number-like identifier '{}'",
                identifier
            );
        }
    }
    ...
    fn test_keyword_patterns() {
        ...
        for keyword in keywords {
            ...
            assert!(
                result.is_err(),
                "Should reject keyword '{}' without # prefix",
                keyword
            );
        }
    }
...
mod integration_tests {
    ...
    fn test_identifier_as_node_name() {
        ...
        assert!(
            result.is_ok(),
            "Should accept valid identifier as node name"
        );
        ...
        assert!(
            result.is_ok(),
            "Should accept complex identifier as node name"
        );
    }
    ...
    fn test_identifier_as_property_key() {
        ...
        assert!(
            result.is_ok(),
            "Should accept valid identifier as property key"
        );
        ...
        assert!(
            result.is_ok(),
            "Should accept multiple identifier property keys"
        );
    }
    ...
    fn test_quoted_strings_bypass_restrictions() {
        ...
        assert!(
            result.is_ok(),
            "Should accept quoted string '1abc' as node name"
        );
        ...
        assert!(
            result.is_ok(),
            "Should accept quoted string '(' as property key"
        );
        ...
        assert!(
            result.is_ok(),
            "Should accept quoted keyword 'true' as node name"
        );
        ...
        assert!(
            result.is_ok(),
            "Should accept quoted string '.1' as property key"
        );
    }
    ...
    fn test_mixed_identifier_and_quoted_strings() {
        ...
        assert!(
            result.is_ok(),
            "Should handle mix of identifiers and quoted strings"
        );
    }
    ...
    fn test_identifier_with_children() {
        ...
        assert!(
            result.is_ok(),
            "Should accept identifiers in nested structures"
        );
    }
}
...
mod edge_cases {
    ...
    fn test_empty_identifier() {
        ...
        use crate::validation::validate_identifier_string_with_context;
        let result =
            validate_identifier_string_with_context("", proc_macro2::Span::call_site(), true);
    ...
    fn test_single_character_identifiers() {
        ...
        for ch in valid_chars {
            ...
            assert!(
                result.is_ok(),
                "Should accept valid single character '{}'",
                ch
            );
        }
        ...
        for ch in invalid_chars {
            ...
            assert!(
                result.is_err(),
                "Should reject invalid single character '{}'",
                ch
            );
        }
    }
    ...
    fn test_unicode_identifiers() {
        ...
        for identifier in unicode_identifiers {
            ...
            assert!(
                result.is_ok(),
                "Should accept valid Unicode identifier '{}'",
                identifier
            );
        }
    }
    ...
    fn test_boundary_cases_for_signs() {
        ...
        assert!(validate_identifier_string_with_context(
            "+a",
            proc_macro2::Span::call_site(),
            true
        )
